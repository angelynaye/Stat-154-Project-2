...
"""
############################### Chnage this part to the place you store the data images ###############
...
"""###Classifier 2 QDA
####Assumption:
1. Both LDA and QDA assume the the predictor variables X are drawn from a multivariate Gaussian (aka normal) distribution. 
2. LDA and QDA require the number of predictor variables (p) to be less then the sample size (n). Furthermore, its important to keep in mind that performance will severely decline as p approaches n. A simple rule of thumb is to use LDA & QDA on data sets where n ≥ 5 × p .
"""
...
"""### '''FOR SAVING AND LOADING MODEL ONLY DELETE AFTERWARDS! '''"""

loss_rf, acc_rf, tac_rf = {},{},{}
loss_rf["CV1"] = 0.15609750947511702
acc_rf["CV1"]= 93.07937021460152 / 100
tac_rf['CV1'] = 95.54718103832994 / 100
  
loss_rf["CV2"] =  0.18924092139667828
acc_rf["CV2"]= 91.47321080406581 / 100
tac_rf['CV2'] = 95.6166013784896 / 100

loss_rf["CV3"] =  0.2480051947674841
acc_rf["CV3"]= 88.42826529802376 / 100
tac_rf['CV3'] =  95.6215599742153 / 100

loss_rf["CV4"]=  0.1829937336180595
acc_rf["CV4"]=  93.09009887202339 / 100
tac_rf['CV4'] =  95.54222244260426 / 100

loss_rf["CV5"]= 0.17472343008238372
acc_rf["CV5"]= 92.90207346431623 / 100
tac_rf['CV5'] =  95.64139435711806 / 100
 
rf_avg_ac = 91.79460373060614 / 100
rf_avg_tac= 95.59379183815142 / 100
